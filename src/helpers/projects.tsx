...
export const ProjectData:Project[] = [
    ...
    },
    {
        ...
        tagline: (
          <>
          Instead of hardcoding the backward passes for specific layers, this project features a custom-built <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">Autograd Engine</span> (similar to PyTorch's <code className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">Tensor</code> system).
          </>
        ),
        description: (
          <>
          This project is a Convolutional Neural Network (CNN) built entirely from scratch in C++. Instead of hardcoding the backward passes for specific layers, this project features a custom-built <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">Autograd Engine</span>. The engine dynamically builds a <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">computation graph</span> during the forward pass and automatically computes gradients via <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">reverse-mode automatic differentiation</span>.
          </>
        ),
        category: "Systems",
        techStack: ["C++", "CMake"],
    ...
    },
    {
        ...
        description: (
          <>
          MiniOS is a pedagogical operating system built as an advanced extension of the MIT xv6 UNIX-like teaching OS. It introduces modern operating system concepts including <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">dynamic scheduling</span>, <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">advanced memory management</span>, and specialized user space applications.
          </>
        ),
        category: "Systems",
        ...
        features: (
          <ul className="space-y-4 list-disc pl-5 mt-2 text-foreground/80 leading-relaxed">
            ...
            <li>
              <strong className="text-foreground">Copy-On-Write (COW) Fork:</strong> Optimized process creation where the parent and child share physical memory pages upon <code className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">fork()</code>. Pages are only duplicated when a process attempts to modify them, managed via a robust reference counting mechanism.
            </li>
            <li>
            ...
            <li>
              <strong className="text-foreground">Log Keeper:</strong> Robust logging mechanism (<code className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">logkeeper</code>) designed to reliably record system events, track operations, and assist in debugging and stress testing across the OS.
            </li>
          </ul>
        ),
        links: [
    ...
    },
    {
        ...
        description: (
          ...
          <br /><br />
          This project applies the concepts of <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">Graph Theory</span>, <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">Shortest Paths</span>, <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">Centrality Algorithms</span>, and <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">Semantic Scoring</span> — making it a strong advanced DSA-based project.
          </>
        ),
    ...
    },
    {
        ...
        description: (
          <div className="space-y-3 mt-2">
            <p>
              This is a multipurpose system designed to ease the workflow of both instructors and students—a one-stop platform to create a quiz, attempt the exam, and display detailed results along with <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">performance histograms</span> and response sheets.
            </p>
            <p>
              <strong>Instructor Portal:</strong> Allows instructors to create quizzes either from a predefined database of questions (for courses like Bio-engineering, Computer Science, Electrical Engineering, and Math) or by manually inputting custom questions and answers.
            </p>
            <p>
              <strong>Student Portal:</strong> Allows students to attempt the quiz and analyze their results. It displays a <span className="bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/30 font-medium">visual performance histogram</span> comparing their score against peers who took the same exam.
            </p>
          </div>
        ),
