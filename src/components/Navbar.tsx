...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full bg-surface/60 backdrop-blur-md">
                        ...
                        return (
                            <Link
                                ...
                                className={`px-2 py-2 rounded-lg text-[15px] font-medium tracking-wide transition-all duration-500 border
                                    ${isActive
                                        ? "bg-teal-500/10 border-teal-500/30 text-primary shadow-[0_0_15px_rgba(20,184,166,0.15)]"
                                        : "border-transparent bg-transparent text-navbar-foreground/80 hover:text-green-300"
                                    }`}
                            >
                                {label}
                            </Link>
            ...
            {/* Corrected bottom gradient line */}
